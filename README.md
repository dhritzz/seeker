...
<p>
  <a style="margin-right: 10px;" href="https://github.com/dhritzz/seeker#installation">
    <img src="https://dabuttonfactory.com/button.png?t=INSTALL&f=Open+Sans&ts=15&tc=000&hp=25&vp=10&c=5&bgt=unicolored&bgc=00e2ff">
  </a>
  <a style="margin-right: 10px;" href="https://github.com/dhritzz/seeker#usage">
...
```bash
git clone https://github.com/dhritzz/seeker.git
cd seeker/
chmod +x install.sh
./install.sh
```
